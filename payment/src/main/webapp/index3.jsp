...
<!-- <input type = "hidden" name="returnUrl" value="http://power933.cafe24.com/payment/INIstdpay_pc_return.jsp"> -->
<input type = "hidden" name="returnUrl" value="http://localhost:8080/payment/INIstdpay_pc_return.jsp">
<!-- <input type = "hidden" name="closeUrl" value="http://power933.cafe24.com/payment/close.jsp"> -->
